...
export const courses: Course[] = [
  { id: "river-art", title: "물길 옆 예술 산책", subtitle: "사찰에서 미술관까지 천천히", theme: "산책", stops: ["yonghwasa", "musimcheon", "cmoa"], walkMinutes: 42, driveMinutes: 14, recommendedMinutes: 210, note: "평탄한 하천 구간 중심", color: "#1b8a83" },
  { id: "downtown-classic", title: "청주 도심 클래식", subtitle: "시장·거리·공원을 한 번에", theme: "미식", stops: ["yukgeori", "seongan-gil", "jungang-park"], walkMinutes: 34, driveMinutes: 16, recommendedMinutes: 210, note: "차보다 도보 이동 추천", color: "#d99a19" },
  { id: "print-river", title: "직지에서 무심천까지", subtitle: "기록문화와 물길을 잇는 탐사", theme: "역사", stops: ["jikji", "cmoa", "yonghwasa", "musimcheon"], walkMinutes: 62, driveMinutes: 19, recommendedMinutes: 300, note: "박물관 관람시간 확보", color: "#bd493f" },
  { id: "art-city", title: "현대미술과 도심 전망", subtitle: "수장고에서 언덕 골목까지", theme: "예술", stops: ["mmca", "suamgol", "jungang-park", "seongan-gil"], walkMinutes: 61, driveMinutes: 21, recommendedMinutes: 300, note: "수암골 오르막 포함", color: "#2b6db1" },
  { id: "museum-belt", title: "청주 박물관 벨트", subtitle: "고대부터 기록과 현대미술까지", theme: "역사", stops: ["national-museum", "mmca", "jikji"], walkMinutes: 150, driveMinutes: 31, recommendedMinutes: 390, note: "차량·대중교통 추천", color: "#6476b6" },
  { id: "market-river", title: "시장과 무심천", subtitle: "먹거리 뒤 가볍게 걷는 코스", theme: "미식", stops: ["yukgeori", "musimcheon", "yonghwasa"], walkMinutes: 30, driveMinutes: 12, recommendedMinutes: 180, note: "반나절 도보 코스", color: "#e17f32" },
  { id: "three-museums", title: "세 개의 미술·박물관", subtitle: "충북 문화와 동시대 미술", theme: "예술", stops: ["national-museum", "mmca", "cmoa"], walkMinutes: 108, driveMinutes: 24, recommendedMinutes: 360, note: "월요일 휴관 여부 확인", color: "#7d5db3" },
  { id: "old-cheongju", title: "오래된 청주의 결", subtitle: "직지부터 전통시장까지", theme: "역사", stops: ["jikji", "jungang-park", "seongan-gil", "yukgeori"], walkMinutes: 64, driveMinutes: 23, recommendedMinutes: 300, note: "도심부 주차 이동 고려", color: "#7b6542" },
  { id: "sunset-city", title: "전망과 야경 코스", subtitle: "수암골에서 성안길 저녁까지", theme: "산책", stops: ["suamgol", "mmca", "seongan-gil", "jungang-park"], walkMinutes: 67, driveMinutes: 21, recommendedMinutes: 270, note: "해 질 무렵 출발 추천", color: "#d36a73" },
  { id: "family-culture", title: "가족 문화 나들이", subtitle: "박물관과 공원을 여유롭게", theme: "가족", stops: ["national-museum", "mmca", "jungang-park"], walkMinutes: 105, driveMinutes: 25, recommendedMinutes: 300, note: "어린이 동반 차량 추천", color: "#4b8b45" },
  { id: "slow-downtown", title: "느린 도심 산책", subtitle: "전시·하천·골목을 잇는 길", theme: "산책", stops: ["cmoa", "musimcheon", "jungang-park", "seongan-gil"], walkMinutes: 60, driveMinutes: 18, recommendedMinutes: 240, note: "걷기 좋은 날 추천", color: "#1b8a83" },
  { id: "full-downtown", title: "청주 도심 하루 완주", subtitle: "기록·예술·물길·시장 총정리", theme: "종합", stops: ["jikji", "cmoa", "musimcheon", "yukgeori", "seongan-gil", "jungang-park"], walkMinutes: 92, driveMinutes: 31, recommendedMinutes: 480, note: "오전 일찍 시작", color: "#17201f" },
  { id: "north-art", title: "북동권 문화 삼각형", subtitle: "박물관·전망·수장형 미술관", theme: "예술", stops: ["national-museum", "suamgol", "mmca"], walkMinutes: 78, driveMinutes: 20, recommendedMinutes: 300, note: "수암골 경사 주의", color: "#5568a8" },
  { id: "river-history", title: "기록과 하천의 하루", subtitle: "직지에서 시장 먹거리까지", theme: "역사", stops: ["jikji", "yonghwasa", "musimcheon", "yukgeori"], walkMinutes: 74, driveMinutes: 25, recommendedMinutes: 330, note: "강변 구간 자전거 가능", color: "#b35738" },
  { id: "art-market", title: "미술관 다음은 시장", subtitle: "문화제조창에서 육거리까지", theme: "미식", stops: ["mmca", "jungang-park", "seongan-gil", "yukgeori"], walkMinutes: 58, driveMinutes: 20, recommendedMinutes: 300, note: "점심 또는 저녁 시장 방문", color: "#8a6b2f" },
  { id: "grand-tour", title: "청주 10대 명소 그랜드 투어", subtitle: "열 곳을 모두 잇는 1박 2일형 코스", theme: "종합", stops: ["national-museum", "mmca", "suamgol", "jungang-park", "seongan-gil", "yukgeori", "musimcheon", "yonghwasa", "cmoa", "jikji"], walkMinutes: 228, driveMinutes: 58, recommendedMinutes: 840, note: "차량 기준 1박 2일 추천", color: "#0e615d" },
];
